...
function miles(canadia){
  /*add your code here*/
  return canadia * .621371
}
...
function feet(mapleMeasurement){
  /*add your code here*/
  return mapleMeasurement / 30.48
}
...
function annoyingSong(nunu){
  /*add your code here*/
  for (let i= 0; i < nunu; num--){
    return `${nunu} bottles of soda on the wall, ${nunu} bottles of soda, take one down pass it around ${--nunu} bottles of soda on the wall`
  }
}
